		...
		<main className="landing__site-wrapper">
			...
			<section className="site__intro-sec grid grid__col-50-50">
				<div className="intro__sec-text center__flex flex__dir-col">
					...
					<div className="text__sec-box" />
					<h1 className="headline-1 margin__tb-8px font-primary">
						Code In Style
					</h1>
					<p className="text-mid margin__tb-8px">
						Designed with <i className="fas fa-heart" /> for
					...
					<Link
						...
						Shop Now{" "}
						<i className="fas fa-arrow-down margin__lr-8px" />
					</Link>
				</div>
			...
			<section className="site__category-sec center__flex flex__dir-col">
				<h2 className="headline-2 margin-2rem font-primary">
					Shop By Categories
				</h2>
				<div className="grid category__sec-cards">
					<Link
						to="/products"
						onClick={() => {
							catClickHandler(CATEGORIES, "TEES");
						}}>
						{" "}
						<CategoryCard
							categoryName={"Tees"}
					...
					<Link
						to="/products"
						onClick={() => {
							catClickHandler(CATEGORIES, "HOODIES");
						}}>
						{" "}
						<CategoryCard
					...
					<Link
						to="/products"
						onClick={() => {
							catClickHandler(CATEGORIES, "STICKERS");
						}}>
						{" "}
						<CategoryCard
							categoryName={"Stickers"}
							cardImage={StickerOne}
						/>
					</Link>
				</div>
			</section>
				...
				<div className="newarrival__sec-cards grid grid__col-50-50">
					<div>
						...
						<Link
							to={"/products"}
							onClick={() => {
								catClickHandler(SUBCATEGORIES, "IPL TEES");
							}}>
							<NewArrivalCard
								cardImage={IplTshirtOne}
								cardHeading={"IPL COLLECTION"}
								cardDiscription={
									"Check out the new IPL Tees collection here."
								}
							/>
						</Link>
					</div>
					<div>
						...
						<Link
							to={"/products"}
							onClick={() => {
								catClickHandler(SUBCATEGORIES, "POLO TEES");
							}}>
							<NewArrivalCard
								cardImage={PoloTshirtOne}
								cardHeading={"POLO NECK TEES"}
								cardDiscription={
									"Check out the new Polo Neck Tees collection here."
								}
							/>
						</Link>
					</div>
